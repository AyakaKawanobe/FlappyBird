...
class UsualGameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if(contact.bodyA.categoryBitMask & scoreCategory) == scoreCategory || (contact.bodyB.categoryBitMask & scoreCategory) == scoreCategory{
            ...
            //ベストスコア更新か確認する
            bestScore = userDefaults.integer(forKey : "usualBest")
            if score + item > bestScore{
                bestScore = score + item
                bestScoreLabelNode.text = "BestScore:\(bestScore)!!!!"
                userDefaults.set(bestScore, forKey: "usualBest")
                //即座に保存する
    ...
    func setupScoreLabel(){
        ...
        let bestScore = userDefaults.integer(forKey: "usualBest")
